...
DoubleNodeSetIterator::DoubleNodeSetIterator(const std::set<GraphTypes::node_id>::const_iterator & underlying):_type(GraphTypes::Iterator::SIMPLE), _current_predecessor(underlying){}
...
DoubleNodeSetIterator::DoubleNodeSetIterator(const std::set<GraphTypes::node_id>::const_iterator & predecessors_begin,
					     ...
					     ):_type(GraphTypes::Iterator::DOUBLE), _predecessors_begin(predecessors_begin), _predecessors_end(predecessors_end), _successors_begin(successors_begin), _successors_end(successors_end), _current_predecessor(current_predecessor), _current_successor(current_successor){}

DoubleNodeSetIterator::DoubleNodeSetIterator(const std::set<GraphTypes::node_id>::const_iterator & predecessors_begin,
					     const std::set<GraphTypes::node_id>::const_iterator & predecessors_end,
					     const std::set<GraphTypes::node_id>::const_iterator & successors_begin,
					     const std::set<GraphTypes::node_id>::const_iterator & successors_end
					     ):_type(GraphTypes::Iterator::DOUBLE), _predecessors_begin(predecessors_begin), _predecessors_end(predecessors_end), _successors_begin(successors_begin), _successors_end(successors_end), _current_predecessor(predecessors_begin), _current_successor(successors_begin){}
