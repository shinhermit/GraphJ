...
PonderableGraph::PonderableGraph(const GraphTypes::EdgeType & edgeType,
				 const GraphTypes::EdgeState & edgeState):
  DirectableGraph(edgeType),
  _edgeState(edgeState){}

PonderableGraph::PonderableGraph(const PonderableGraph & source):
  DirectableGraph(source),
...
void PonderableGraph::add_edge(const GraphTypes::node_id & origin,
...
void PonderableGraph::remove_edge(const GraphTypes::node_id & origin,
				  const GraphTypes::node_id & target)
{
  std::map<Edge, GraphTypes::Cost>::iterator it;
...
void PonderableGraph::setCost(const GraphTypes::node_id & origin,
			      const GraphTypes::node_id & target,
			      const GraphTypes::Cost & cost
...
GraphTypes::Cost PonderableGraph::getCost(const GraphTypes::node_id & origin,
					  const GraphTypes::node_id & target
