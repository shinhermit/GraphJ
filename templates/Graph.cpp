...
Graph<Type>::Graph(const GraphTypes::EdgeType & edgeType, const GraphTypes::EdgeState & state, const GraphTypes::NodeType & nodeType):PonderableGraph::PonderableGraph(edgeType, state), _nodeType(nodeType){}
...
template <typename Type>
void Graph<Type>::add_node(const GraphTypes::node_id & node) throw(GraphException::InvalidOperation){
  if(_nodeType == GraphTypes::CONTAINER){
...
template <typename Type>
void Graph<Type>::add_edge(const GraphTypes::node_id & src_node, const Type & content1, const GraphTypes::node_id & target_node, const Type & content2, const GraphTypes::Cost & cost){
...
template <typename Type>
void Graph<Type>::add_edge(const GraphTypes::node_id & existing_src, const GraphTypes::node_id & existing_target, const GraphTypes::Cost & cost) throw(GraphException::InvalidOperation){
...
template <typename Type>
void Graph<Type>::set_node_content(const GraphTypes::node_id & node, const Type & content) throw(GraphException::InvalidNodeID, GraphException::InvalidOperation){
  if( has_node(node) ){
    if(_nodeType == GraphTypes::CONTAINER){
...
template <typename Type>
Type Graph<Type>::get_node_content(const GraphTypes::node_id & node)const throw(GraphException::InvalidNodeID, GraphException::InvalidOperation){
