...
private:
  ...
  static std::string _graphviz_node_label_mapping(const Graph<Type> & graph,
						  const std::map<GraphTypes::node_id, std::string> & label_mapper);

  static std::string _graphviz_node_color_mapping(const Graph<Type> & graph,
  ...
  static std::string _graphviz_node_meta_mapping(const Graph<Type> & graph,
						 const std::map<GraphTypes::node_id, std::string> & label_mapper,
						 const std::map<GraphTypes::node_id, NamedColor::ColorName> & color_mapper);
